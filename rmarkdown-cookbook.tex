...
\midrule
\endhead
title: ``Radix for R Markdown''\tabularnewline
author:\tabularnewline
- name: ``JJ Allaire''\tabularnewline
url: \url{https://github.com/jjallaire}\tabularnewline
affiliation: RStudio\tabularnewline
affiliation\_url: \url{https://www.rstudio.com}\tabularnewline
output: radix::radix\_article\tabularnewline
\bottomrule
\end{longtable}
